...
class RadiationNetCDF(BaseNetCDF):
    ...
    def create_radiation_variables(self, dataset):
        ...
        self.create_variable(dataset, "downwelling_longwave_flux_in_air", data_type, dims, self.df[self.lwdn_header], self.lwdn_header, **{**attrs, **lwdn_attrs})

        # lwup
        lwup_attrs = {"standard_name": "upwelling_longwave_flux_in_air",
                      "long_name": "Upwelling Longwave Radiation in air"}
        self.create_variable(dataset, "upwelling_longwave_flux_in_air", data_type, dims, self.df[self.lwup_header], self.lwup_header, **{**attrs, **lwup_attrs})

        # swdn
        swdn_attrs = {"standard_name": "downwelling_shortwave_flux_in_air",
                      "long_name": "Downwelling Shortwave Radiation in air"}
        self.create_variable(dataset, "downwelling_shortwave_flux_in_air", data_type, dims, self.df[self.swdn_header], self.swdn_header, **{**attrs, **swdn_attrs})

        # swup
        swup_attrs = {"standard_name": "upwelling_shortwave_flux_in_air",
                      "long_name": "Upwelling Shortwave Radiation in air"}
        self.create_variable(dataset, "upwelling_shortwave_flux_in_air", data_type, dims, self.df[self.swup_header], self.swup_header, **{**attrs, **swup_attrs})


    def create_specific_variables(self, dataset):
        # create variables
        self.create_radiation_variables(dataset)
        ...
        temp_attrs = {"units": "K",
                      ...
                      "coordinates": "latitude longitude",}
        self.create_variable(dataset, "radiometer_body_temperature", np.float32, ("time",), self.df[self.body_temp_header], self.body_temp_header, **temp_attrs)
        ...
        self.create_qc_variable(dataset,"qc_flag_downwelling_shortwave", self.swdn_header, ('time',), **attrs)

        # swup
        attrs = {"long_name": "Data Quality flag: upwelling shortwave",
                 "flag_values": "0b, 1b, 2b, 3b, 4b, 5b, 6b",
                 "flag_meanings": "0: not_used \n1: good data \n2: no_data \n3: bad_data_sw_radiation_<_0 \n4: bad_data_sw_radiation_>_2000_W_m-2 \n5: suspect_data \n6: timestamp_error"}
        self.create_qc_variable(dataset,"qc_flag_upwelling_shortwave", self.swup_header, ('time',), **attrs)
        
        # lwdn
        attrs = {"long_name": "Data Quality flag: downwelling longwave",
                 "flag_values": "0b, 1b, 2b, 3b, 4b, 5b, 6b",
                 "flag_meanings": "0: not_used \n1: good data \n2: no_data \n3: bad_data_lw_radiation_<_0 \n4: bad_data_lw_radiation_>_1000_W_m-2 \n5: suspect_data \n6: timestamp_error"}
        self.create_qc_variable(dataset,"qc_flag_downwelling_longwave", self.lwdn_header, ('time',), **attrs)

        # lwup
        attrs = {"long_name": "Data Quality flag: upwelling longwave",
                 "flag_values": "0b, 1b, 2b, 3b, 4b, 5b, 6b",
                 "flag_meanings": "0: not_used \n1: good data \n2: no_data \n3: bad_data_sw_radiation_<_0 \n4: bad_data_lw_radiation_>_1000_W_m-2 \n5: suspect_data \n6: timestamp_error"}
        self.create_qc_variable(dataset,"qc_flag_upwelling_longwave", self.lwup_header, ('time',), **attrs)
        ...
        self.create_qc_variable(dataset,"qc_flag_body_temperature", self.body_temp_header, ('time',), **attrs)

        # cleaning
        attrs = {"long_name": "Data Quality flag: sensor cleaning",
                 "flag_values": "0b, 1b, 2b, 3b, 4b",
                 "flag_meanings": "0: not_used \n1: good data \n2: bad_data_sensor_being_cleaned \n3: suspect_data \n4: timestamp_error"}
        self.create_qc_variable(dataset,"qc_flag_cleaning", "cleaning", ('time',), **attrs)